...
<head>
    ...
    <link href="/arma/plugin/bootswatch-gh-pages/cerulean/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link href="/arma/plugin/bootstrap-3.3.4-dist/css/bootstrap-menu.css" rel="stylesheet" type="text/css"/>
    <script src="/arma/js/password.js?version=<%= new Date()%>" type="text/javascript"></script>
    <link href="/arma/css/main.css" rel="stylesheet" type="text/css"/>
    <script>
        function logout() {
            $.post("/arma/auth", function () {
                window.location.href = "/arma/login.jsp";
            });
        }
    </script>
</head>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/arma"><span class="glyphicon glyphicon-home"></span> &nbsp; ARMA</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                ...
                <%--<li><a href="/arma/pages/admin/users.jsp">Пользователи</a></li>--%>
                <%--<li><a href="/arma/pages/admin/emailattrs.jsp">Параметры почты</a></li>--%>
                <%--</ul>--%>
                <%--</li>--%>
