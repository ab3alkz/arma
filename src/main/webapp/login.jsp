...
<head>
    ...
    <link href="/arma/plugin/font-awesome-4.6.3/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <link href="/arma/plugin/bootstrap-3.3.4-dist/css/bootstrap.css" rel="stylesheet" type="text/css"/>
    <script src="/arma/js/login.js" type="text/javascript"></script>
    <link href="/arma/css/login.css" rel="stylesheet" type="text/css"/>
    <script src="/arma/plugin/jquery/jquery-1.11.3.min.js" type="text/javascript"></script>
    <script src="/arma/plugin/bootstrap-3.3.4-dist/js/bootstrap.js"  type="text/javascript"></script>
</head>
<body>
<div id="loginMark"/>
<div class="container">
